...
const ProfilePage = () => {
  ...
  const { loading: schoolChoicesLoading }: QueryResult = useAuthQuery(
    GET_SCHOOL_CHOICES_QUERY,
    {
  ...
  const { loading: classYearChoicesLoading }: QueryResult = useAuthQuery(
    GET_CLASS_YEAR_CHOICES_QUERY,
    {
  ...
  const { loading: positionChoicesLoading }: QueryResult = useAuthQuery(
    GET_POSITION_CHOICES_QUERY,
    {
  ...
  const isLoading: boolean =
    classYearChoicesLoading ||
    schoolChoicesLoading ||
    positionChoicesLoading ||
    !classYearChoices ||
    !schoolChoices ||
    !positionChoices;
        ...
        {isLoading ? (
          ...
          <Space className={styles.profileItemSpace} direction="vertical">
            ...
            <ProfileItem
              ...
              display={(values) =>
                values.school != null ? values.school : "Not set"
              }
              ...
              input={
                ...
                >
                  <Select
                    placeholder="School"
                    className={styles.fullWidthInput}
                    options={Object.entries(schoolChoices).map(
                      ([key, value]) => ({
              ...
              input={
                ...
                >
                  <Select
                    ...
                    className={styles.fullWidthInput}
                    options={Object.entries(classYearChoices).map(
                      ([key, value]) => ({
                        label: value.toString(),
                        value: parseInt(key),
                      }),
